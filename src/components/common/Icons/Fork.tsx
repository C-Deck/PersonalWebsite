import { SvgIcon } from "./IconTypes"
import React from "react"

const Fork: SvgIcon = ({ width = 16, height = 16, fillColor = `#000` }): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={width} height={height}>
      ...
      ></path>
      <path fill={fillColor} fillRule="evenodd" d="M11.25 16.25v-5h1.5v5h-1.5z"></path>
    </svg>
  )
}
